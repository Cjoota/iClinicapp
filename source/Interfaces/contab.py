...
class ContabilidadePage:
    ...
    def build_view(self):
        ...
        # AJUSTE AQUI: tablecontent recebe buildtable dentro de um Container expandido
        ...
        self.caixainterface = ft.Column([
            ...
            ft.Row([
                ft.TextButton(icon=ft.Icons.SEND, text="Registrar", style=ft.ButtonStyle(color=ft.Colors.BLACK),
                              icon_color=ft.Colors.BLACK45, on_click=registrar_pagamento)
            ], alignment=ft.MainAxisAlignment.CENTER, vertical_alignment=ft.CrossAxisAlignment.CENTER
            ),
        ...
        self.retirointerface = ft.Column([
            ...
            ft.Row([
                ft.TextButton(icon=ft.Icons.SEND, text="Registrar", style=ft.ButtonStyle(color=ft.Colors.BLACK),
                              icon_color=ft.Colors.BLACK45, on_click=retirar_valores)
            ], alignment=ft.MainAxisAlignment.CENTER, vertical_alignment=ft.CrossAxisAlignment.CENTER
            ),
        ], alignment=ft.MainAxisAlignment.CENTER, horizontal_alignment=ft.CrossAxisAlignment.CENTER)
        self.contabcontent = ft.Column([
            ...
            # AJUSTE AQUI: cardmain recebe o container expandido da tabela
            ft.Container(
                content=self.main_interface_instance.cardmain(
            ...
            ft.Row([
                ft.Container(
                    content=ft.ListView(
                        controls=[
                            ft.Row([
                                ft.Text("Conta", weight=ft.FontWeight.BOLD, size=15),
                                ft.Text("Valor", weight=ft.FontWeight.BOLD, size=15),
                                ft.Text("Vencimento", weight=ft.FontWeight.BOLD, size=15),
                                ft.Text("Status", weight=ft.FontWeight.BOLD, size=15),
                                ft.Text("Ações", weight=ft.FontWeight.BOLD, size=15),
                            ]),
                            *linhas  # cada linha é um ft.Row com as células
                        ],
                        expand=True,
                        spacing=5,
                        padding=10,
    ...
    def gerar_linhas(self, data):
        ...
        for i, conta in enumerate(data):
            linhas.append(
                ft.Row([
                    ft.Text(conta.descricao),
                    ft.Text(f"R${conta.valor}"),
                    ft.Text(conta.vencimento),
                    ft.Text(conta.status),
                    ft.IconButton(
                        icon=ft.Icons.DELETE,
                        icon_color=ft.Colors.BLACK,
                        bgcolor=ft.Colors.RED_100,
                        on_click=lambda e, idx=i: self.page.run_task(self.deletar_conta, idx)
                    )
                ])
            )
        return linhas